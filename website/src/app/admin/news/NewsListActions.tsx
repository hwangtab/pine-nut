      ...
      <div className="flex items-center gap-2">
        {!isDeleted && (
          <Link
            ...
            className="min-h-[44px] px-5 py-3 text-base font-bold text-[var(--color-forest)] bg-[var(--color-forest)]/10 hover:bg-[var(--color-forest)]/20 rounded-lg transition-colors"
          >
            수정
          </Link>
        )}
