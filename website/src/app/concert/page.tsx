...
export const metadata: Metadata = {
  ...
  description:
    "2026년 8월 1일(토) 오후 1시–8시, 청와대 앞. 잣나무 11만 그루가 베어지기 전에, 풍천리를 지키려는 음악가 12팀이 모입니다. 강민정·경하와 세민과 멍구와 흑염소·길가는 밴드·김민정(알마즈)·남수·물장구클럽·아나자오·이서영·자이·제트싸이져·종이코트·치핵.",
  openGraph: {
    title: "베어지기 전에 풍천리 — 8·1 청와대 앞 공연",
    description:
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-8 overflow-hidden rounded-2xl border border-[var(--color-border)] shadow-lg">
            <Image
              ...
              alt="베어지기 전에 풍천리 공연 포스터 — 2026년 8월 1일 토요일 오후 1시부터 8시, 청와대 앞. 출연: 강민정, 경하와 세민과 멍구와 흑염소, 길가는 밴드, 김민정(알마즈), 남수, 물장구클럽, 아나자오, 이서영, 자이, 제트싸이져, 종이코트, 치핵"
              width={1200}
              height={1697}
