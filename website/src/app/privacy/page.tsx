            ...
            <div className="space-y-4">
              ...
              <div className="bg-[var(--color-bg)] rounded-[var(--radius-card)] p-5">
                ...
                <EditableRichText
                  ...
                  defaultValue="이름 공개에 동의하신 분에 한해 이름 또는 닉네임과 거주 지역(시·도, 시·군·구), 서명한 날짜가 /petition 페이지 하단 서명자 명단에 공개됩니다. 이메일, 소속 단체, 제안 한마디, 접속 정보는 공개되지 않습니다. 공개에 동의하지 않으셔도 서명은 총 서명 수에 그대로 반영되며, 명단에는 표시되지 않습니다. 2026년 8월 28일 이전에 접수된 서명(65건)은 거주 지역을 수집하지 않아 명단에 포함되지 않으며, 총 서명 수에는 그대로 포함됩니다."
                  page="privacy"
                  section="section1"
                  renderMode="paragraph"
                  className="text-[var(--color-text-muted)] text-[15px] leading-relaxed"
