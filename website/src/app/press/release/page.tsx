      ...
      <div className="print-page max-w-3xl mx-auto px-6 py-12">
        ...
        <section className="mb-8 space-y-6">
          ...
          <div>
            ...
            <ol className="mt-3 space-y-2 text-base text-gray-700 leading-relaxed list-decimal list-inside">
        ...
        {/* Quote */}
        <section className="mb-8">
          <blockquote className="border-l-4 border-[var(--color-forest)] pl-5 py-3 bg-gray-50 rounded-r-xl">
