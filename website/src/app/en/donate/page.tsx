    ...
    <div className="min-h-screen bg-[var(--color-bg)]">
        ...
        <blockquote className="paper max-w-xl mx-auto px-6 py-5 text-center">
          <div className="relative z-[1] text-[var(--color-text)]">
            ...
            <EditableText
              ...
              page="en/donate"
              section="quote"
              className="mt-2 font-serif-display italic text-lg text-[var(--color-text-muted)]"
            />
          </div>
        </blockquote>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12 sm:py-16 space-y-12">
        <section aria-label="Donate by bank transfer">
          <EditableText contentKey="en.donate.bank.heading" defaultValue="Donate by bank transfer" as="h2" page="en/donate" section="bank" className="font-serif-display font-bold text-xl sm:text-2xl mb-6 text-[var(--color-text)]" />
        ...
        <section aria-label="How donations will be used">
          <EditableText contentKey="en.donate.funds.heading" defaultValue="How donations are used" as="h2" page="en/donate" section="funds" className="font-serif-display font-bold text-xl sm:text-2xl mb-6 text-[var(--color-text)]" />
          <div className="paper p-6 sm:p-8">
            <div className="relative z-[1]">
              ...
              >
                {(items) => {
                  ...
                  const colorMap = ["var(--color-forest-light)", "var(--color-forest)", "var(--color-sky)", "var(--color-earth)"];
