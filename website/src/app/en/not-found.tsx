  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)]">
      ...
      <section className="max-w-2xl mx-auto px-6 py-14 md:py-16 text-center">
        <EditableLink contentKey="en.notfound.primary.href" defaultHref="/en" page="en" section="not-found" className="inline-flex items-center justify-center bg-[var(--color-forest)] text-white font-semibold px-8 py-3 rounded-lg hover:bg-[var(--color-forest-light)] transition-colors min-h-[44px]">
