    ...
    <article>
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 bg-[var(--color-bg-warm)]">
        <div className="max-w-3xl mx-auto">
          ...
          {/* ── 교통 안내 ── */}
          <div className="mt-12">
            <h3 className="text-xl md:text-2xl font-bold text-[var(--color-forest)] mb-8 text-center">
              교통 안내
            </h3>
              ...
              <div className="bg-white rounded-2xl p-6 md:p-8 border-2 border-[var(--color-forest)]/15 shadow-sm">
                ...
                <ul className="space-y-4 text-sm md:text-base text-[var(--color-text-muted)] leading-relaxed">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-[var(--color-text)]">서울 → 풍천리</strong>
                      <br />
                      서울양양고속도로 → 동홍천IC → 44번 국도 → 화촌면 방면
                      <br />
                      <span className="text-[var(--color-forest)] font-semibold">약 1시간 30분</span>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="shrink-0 mt-1.5 w-1.5 h-1.5 rounded-full bg-[var(--color-forest)]" />
                    <span>
                      <strong className="text-[var(--color-text)]">춘천 → 풍천리</strong>
                      <br />
                      5번 국도 → 홍천 → 44번 국도 → 화촌면 방면
                      <br />
                      <span className="text-[var(--color-forest)] font-semibold">약 50분</span>
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 md:p-8 border-2 border-[var(--color-forest)]/15 shadow-sm">
                ...
                <ul className="space-y-4 text-sm md:text-base text-[var(--color-text-muted)] leading-relaxed">
                  <li className="flex items-start gap-2">
                    <span className="shrink-0 mt-1.5 w-1.5 h-1.5 rounded-full bg-[var(--color-forest)]" />
                    <span>
                      <strong className="text-[var(--color-text)]">서울 → 홍천</strong>
                      <br />
                      동서울터미널에서 홍천행 시외버스
                      <br />
                      <span className="text-[var(--color-forest)] font-semibold">약 1시간 30분, 수시 운행</span>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="shrink-0 mt-1.5 h-1.5 w-1.5 rounded-full bg-[var(--color-forest)]" />
                    <span>
                      <strong className="text-[var(--color-text)]">홍천 → 화촌면</strong>
                      <br />
                      홍천버스터미널에서 화촌면행 농어촌버스
                      <br />
                      <span className="text-[var(--color-forest)] font-semibold">약 40분</span>
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="shrink-0 mt-1.5 w-1.5 h-1.5 rounded-full bg-[var(--color-forest)]" />
                    <span>
                      <strong className="text-[var(--color-text)]">화촌면 → 풍천리</strong>
                      <br />
                      마을버스 또는 도보
                    </span>
                  </li>
            ...
            <div className="mt-6 bg-[var(--color-forest)]/5 rounded-2xl p-6 md:p-8 border border-[var(--color-forest)]/10">
              ...
              <ul className="space-y-2.5 text-sm md:text-base text-[var(--color-text-muted)] leading-relaxed">
                <li className="flex items-start gap-2">
                  ...
                  <span>풍천리는 가리산 자락 해발 400~700m 산촌입니다</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="shrink-0 mt-1">
                    <svg className="w-4 h-4 text-[var(--color-forest)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  ...
                  <span>대중교통이 제한적이므로 자가용 이용을 권장합니다</span>
                </li>
              </ul>
              <div className="mt-5 flex items-start gap-3 bg-white/60 rounded-xl p-4 border border-[var(--color-forest)]/10">
                ...
                <p className="text-sm md:text-base text-[var(--color-text)]">
                  <strong>집회 참여 시 카풀이 가능합니다</strong> — 캠페인 페이지에서 문의해주세요
                </p>
              </div>
            </div>
          </div>
