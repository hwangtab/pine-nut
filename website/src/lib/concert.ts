...
export const FEAST_LINEUP: ConcertArtist[] = [
  ...
  },
  {
    ...
    // 이력서에는 윤석열 퇴진 집회 공연도 적혀 있으나 넣지 않기로 했다.
    // 네 자리를 넘기면 문장이 아니라 목록으로 읽혀서 골라야 했고, 팔레스타인
    // 연대를 택했다.
    blurb:
      "독학으로 음악을 익힌 싱어송라이터. 아버지 성 ‘최’와 어머니 성 ‘양’에 ‘다음’을 붙인 이름으로, 호주제에 맞선다는 뜻을 담아 지었습니다. 그 이름을 여러 나라 말로 씁니다 — 다음, NEXT, 次, Nächste, 翌. 세월호 10주기 추모, 수요시위, 팔레스타인 연대 집회, 5·18 기념식 같은 자리에서 노래해왔습니다.",
...
export const MOK_TIME_LABEL = "오후 2시 – 6시경";
